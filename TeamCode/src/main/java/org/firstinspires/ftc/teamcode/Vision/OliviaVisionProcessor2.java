...
public class OliviaVisionProcessor2 implements VisionProcessor
{
    ...
    public Object processFrame(Mat inputFrameRGB, long captureTimeNanos) {
        ...
        // for each contour -> in pixel coordinates
        int idx = 0;
        //List<Point> centroids = new ArrayList<>(contours.size());
        ...
        telemetry.addData("Width: ", debugViewBlue.width());
        telemetry.addData("Height: ", debugViewBlue.height());
